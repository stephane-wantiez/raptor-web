...
class User extends ActiveRecord
{
	...
	public function __construct($id=0,$facebookId="",$userName="",$password="",$firstName="",$lastName="",$email="",$lastConnectionDT=0,$nbBombs=0)
	{
		parent::__construct('user',$id);
		$this->fillWithData($id,$facebookId,$userName,$password,$firstName,$lastName,$email,$lastConnectionDT,$nbBombs);
	}
	
	public function fillWithData($id=0,$facebookId="",$userName="",$password="",$firstName="",$lastName="",$email="",$lastConnectionDT=0,$nbBombs=0)
	{
		$this->id         		= (int) $id;
